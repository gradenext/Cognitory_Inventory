      ...
      <div className="bg-white/10 backdrop-blur-md border border-white text-white rounded-2xl shadow-md p-5 w-full h-fit max-w-md flex flex-col gap-y-2 transition hover:shadow-lg">
        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-between gap-2 pt-4 border-t border-white/10 mt-2">
          <button
            ...
            className={`px-4 py-2 text-sm text-white rounded-lg flex justify-center items-center gap-2 transition w-full cursor-pointer ${
              approved
        ...
        {role === "user" && (
          <button
            ...
            className={`px-4 py-2 text-sm rounded-lg flex justify-center items-center gap-2  w-full cursor-pointer bg-white text-black hover:bg-black hover:text-white transition-colors duration-300 `}
          >
            View Profile
          </button>
        )}
        {role === "user" && (
          <button
            disabled={disabled}
            onClick={() => navigate(`/admin/question/user/${user?._id}`)}
            className={`px-4 py-2 text-sm rounded-lg flex justify-center items-center gap-2  w-full cursor-pointer bg-white text-black hover:bg-black hover:text-white transition-colors duration-300 `}
          >
            View Questions
          </button>
