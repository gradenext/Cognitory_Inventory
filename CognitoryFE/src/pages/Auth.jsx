...
const Auth = () => {
  return (
    <div className="relative h-screen w-full bg-black text-white overflow-hidden">
      {/* Background Layer */}
      <div className="absolute inset-0 z-0 flex flex-col justify-between items-center py-12">
        <div className="scale-150">
          <RotatingPyramid />
        </div>
        <div className="text-[4rem] sm:text-[8rem] text-white/50 font-bold leading-none mt-8 ">
          <TypewriterText />
        </div>
      </div>
